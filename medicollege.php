...
<head>
    ...
    <title>USER</title>
    <link rel="stylesheet" href="medicollege.css">
</head>
<body>
<div class="medi"><p>MEDICAL AND NURSING COLLEGES<p></div>
<?php
...
$sql = "SELECT title,address,url, image_path FROM medicollege ORDER BY title ASC";
